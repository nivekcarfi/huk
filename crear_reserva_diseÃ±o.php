...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $query)) {
		...
		header("Location: reservas_diseño.php");// nos redirige al login cuando hayamos creado la reserva
		exit;
...
<html lang="en">
  <head>
    ...
    <title>Añadir reserva - Admin</title>
    <meta
                ...
                <div class="row">
                    <div class="col-md-6 ms-auto me-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <form id="reservation-form" action="crear_reserva_diseño.php" method="post">
                                        <!-- Cliente -->
                                        <div class="form-group">
                                          <label for="client">Cliente</label>
                                          <select class="form-select form-control" id="client" name="client" onchange="loadVehicles(this.value)">
                                            <option value="">Seleccione un cliente</option>
                                            <?php
                                              // fetch clients from database
                                              $clients = mysqli_query($conn, "SELECT * FROM clientes");
                                              while ($client = mysqli_fetch_assoc($clients)) {
                                                echo "<option value='".$client['id']."'>".$client['nombre']."</option>";
                                              }
                                            ?>
                                          </select>
                                        </div>
