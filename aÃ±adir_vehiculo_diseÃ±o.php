...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($matricula) && !empty($marca) && !empty($modelo) && !empty($client_id)) {
        // Inserta el nuevo vehículo en la base de datos, vinculándolo con el cliente
        $sql = "INSERT INTO vehicles (matricula, modelo, marca, client_id) VALUES ('$matricula', '$modelo', '$marca', '$client_id')";
...
<html lang="en">
  <head>
    ...
    <title>Añadir vehículo - Admin</title>
    <meta
                    ...
                    <div class="row">
                      <form method="POST" action="">
                        ...
                        <div class="card-action">
                            ...
                            <button type="button" class="btn btn-danger" onclick="window.location.href='vehiculos_diseño.php'">Volver</button>
                        </div>
