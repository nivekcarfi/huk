...
if (isset($_GET['id'])) {
    ...
    // Consulta para obtener el client_id a partir del id del vehículo
    $sql_client = "SELECT client_id FROM vehicles WHERE id = $id";
    $result_client = $conn->query($sql_client);

    // Verifica si se encontró un resultado
    if ($result_client->num_rows > 0) {
        $row_client = $result_client->fetch_assoc();
        $client_id = $row_client['client_id'];  // Asigna el client_id
    } else {
        die("No se encontró un client_id para el vehículo con ID $id.");
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($matricula) && !empty($marca) && !empty($modelo)) {
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                header("Location: vehiculos_diseño.php?client_id=$client_id");
                exit();
            } else {
...
<html lang="en">
  <head>
    ...
    <title>Modificar vehículo - Admin</title>
    <meta
              ...
              <div class="container-fluid d-flex align-items-center">
                  ...
                  <nav class="navbar navbar-header-left navbar-expand-lg navbar-form nav-search p-0 d-none d-lg-flex">
                      <div class="d-flex">
                          ...
                          <button class="btn btn-black btn-border btn-round me-3" onclick="window.location.href='vehiculos_diseño.php';">Mis vehículos</button>
                    ...
                    <div class="row">
                      <form method="POST" action="">
                        ...
                        <div class="card-action">
                            ...
                            <button type="button" class="btn btn-danger" onclick="window.location.href='vehiculos_diseño.php?client_id=<?php echo $client_id; ?>'">Volver</button>
                        </div>
